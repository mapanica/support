...
// $ch = curl_init('https://www.sandbox.paypal.com/cgi-bin/webscr'); // for testing
...
//		$res = fgets ($fp, 1024);
		if (strcmp ($res, 'VERIFIED') == 0) {
			...
			include('db-connect.inc.php');
			 ...
			 if ($payment_status == 'Completed' AND $option_name1=='contribution_tracking_id' AND $business == 'donations@hotosm.org') {
    //  if ($payment_status == 'Completed' AND $option_name1=='contribution_tracking_id' AND $business == 'donations-facilitator@hotosm.org') { // testing
        if ($payment_currency=='USD') {
					...
					if ($sql_result AND mysql_num_rows($sql_result)==1) {
						...
						$payment_amount_usd = $payment_amount / $exc_rate['rate'];
					}
				}
